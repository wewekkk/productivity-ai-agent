...
export function SessionReport({ quest, subtask, onBack, onComplete, onPartial, onStuck }: { quest: Quest; subtask: Subtask; onBack: () => void; onComplete: () => void; onPartial: () => void; onStuck: () => void }) {
